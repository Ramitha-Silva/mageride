...
D7_APP=(
  ...
  Sms__FitSmsApiToken Jwt__SigningKeyPem Otp__ResendCooldownSec Otp__MaxPerHour
...
for v in Jwt__SigningKeyPem Sms__FitSmsApiToken Onepay__ApiKey Onepay__WebhookSecret \
