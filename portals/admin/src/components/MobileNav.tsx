 ...
 *
 * D2 §AP gives the portal three widths — 375 / 768 / 1024 — and puts "sidebar +
 * content + detail" at the desktop one. Below it the sidebar becomes this: the
...
export function MobileNav({
  ...
  // Keyed on the pathname rather than on the click, so a link the router handles
  // and a link that reloads behave alike.
  ...
  useEffect(() => {
    ...
    // this listener on every keystroke elsewhere on the page. The setter React
    // hands back is stable.
