 ...
 *
 * Vite 8 transforms with Oxc rather than esbuild, so the option lives under
 * `oxc`. That is the only reason this file differs from the one in
 * `portals/ui`, which predates the upgrade.
 */
