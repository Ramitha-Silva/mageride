/**
 * The executable form of the C104 Definition of Done item:
 *
...
const banned = JSON.parse(
  await readFile(
    join(appRoot, '../eslint-config/banned-styling-packages.json'),
    'utf8',
  ),
);
...
if (findings.length > 0) {
  process.stderr.write(
    'AL-52 violation — runtime CSS-in-JS in the Admin Portal production bundle:\n\n' +
