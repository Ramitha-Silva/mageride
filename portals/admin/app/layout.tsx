 ...
 * third party in the render path of an internal console.
 */
...
export const metadata: Metadata = {
  title: 'MageRide Admin',
  description: 'MageRide back-office — admin.mageride.lk',
  // An internal console has nothing to say to a crawler, and `admin.mageride.lk`
  // resolving in a search result is an invitation to try the sign-in form.
