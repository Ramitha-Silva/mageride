...
/**
 * The driver-guide chapter card — S19's fourth family, one per chapter.
 *
...
export const alt = `${t('www.brand.name')} — ${t('www.page.guide.driverHeading')}`;
  ...
  return new ImageResponse(
    (
      <OgCard
        ...
        eyebrow={t('www.page.guide.driverHeading')}
