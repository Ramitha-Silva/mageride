...
/**
 * The `drivers` card — one of the four role-page cards (S19's third family).
 *
...
export const alt = `${t('www.brand.name')} — ${t(PAGES.drivers?.title ?? 'www.brand.tagline')}`;

export const generateStaticParams = ogLocaleParams;
export const dynamicParams = false;

export default routeOgImage('drivers');
