...
S.append("")
S.append("- `SCR-DA-012` / `SCR-DI-012` `standby_toggle` — re-tagged **[MERGED → SCR-DA/DI-010]** by")
S.append("  AL-46 / US-25.8: the Online/Offline toggle is a dashboard *state*, not a screen. It has no")
S.append("  wireframe block and must not be built as a separate screen (fenced in C070 and C088).")
