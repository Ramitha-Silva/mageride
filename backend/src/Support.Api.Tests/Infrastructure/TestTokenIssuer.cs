...
/// </summary>
/// <remarks>
/// support-svc is a token consumer: it holds no signing key and, in production, resolves iam-svc's
...
internal sealed class TestTokenIssuer
{
    ...
    /// <summary>A Support CSR — the role URD §2.3 gives the ticket queue to.</summary>
    public string SupportCsr(Guid userId) => Issue(userId, [MageRideRoles.SupportCsr], MageRideApps.Admin);
