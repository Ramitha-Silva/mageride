...
/// would test C020 again and make this suite fail for reasons that are not fan-out's.
/// <para>
...
/// and is bound to a vehicle (E-02). Keeping the two visibly separate is the point — a hub that
/// accepted an MQTT token, or a broker that accepted an API token, would be the E-02 mistake.
/// </para>
/// </remarks>
