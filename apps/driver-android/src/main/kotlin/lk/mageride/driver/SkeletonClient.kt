 ...
 *
 * The real wiring is Koin (`sharedModules`) and belongs to C076.
 */
internal object SkeletonClient {
    ...
    /** EMQX, from the emulator's point of view. See [baseUrl]. */
    var mqttHost: String = "10.0.2.2"
    var mqttPort: Int = 1883

    /**
     * The vehicle this driver publishes for.
     *
     * The one `db/seed/skeleton.sql` creates. A real Driver App reads it from
     * `GET /v1/drivers/me/vehicles` and the US-9.6 live-vehicle selection; C076 does that.
     */
    var vehicleId: String = "00000000-0000-4000-8000-00000000c001"
    ...
    fun api(): MageRideApi {
        val config = ApiConfig(
            ...
            userAgent = "mageride-driver-skeleton/1.0",
        )
