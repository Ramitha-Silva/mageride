...
// source of truth shared with Figma, SwiftUI and the Tailwind preset. A driver whose home screen
// turned the MageRide orange green would be looking at a different product from the one the
// wireframes describe. Not a preference — do not add it without a micro-change-set.
 ...
 *   before a driver finds them at night.
 */
@Composable
